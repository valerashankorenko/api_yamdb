...
class GetTokenMixin(mixins.CreateModelMixin):
    """
...
class UserModelMixin(mixins.CreateModelMixin, mixins.ListModelMixin):
    """
...
class UserRegisterMixin(mixins.CreateModelMixin):
    """
    ...
    def create(self, request):
        ...
        if User.objects.filter(
            ...
            # зарегестрированному ранее пользователю
