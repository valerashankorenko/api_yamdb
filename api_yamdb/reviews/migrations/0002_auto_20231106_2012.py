# Generated by Django 3.2 on 2023-11-06 17:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='title',
            name='year',
            field=models.PositiveSmallIntegerField(default=1, validators=[reviews.models.validate_year], verbose_name='Год выхода произведения'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='user',
        ...
        migrations.AddField(
            model_name='user',
            name='username',
            field=models.CharField(default=1, max_length=150, unique=True, validators=[django.core.validators.RegexValidator(regex='^[\\w.@+-]+$')], verbose_name='Имя пользователя (логин)'),
            preserve_default=False,
        ),
